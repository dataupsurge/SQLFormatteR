...
[![Codecov test
coverage](https://codecov.io/gh/dataupsurge/SQLFormatteR/graph/badge.svg)](https://app.codecov.io/gh/dataupsurge/SQLFormatteR)
...
**SQLFormatteR** is an R package that provides an easy-to-use wrapper
for the [`sqlformat-rs`](https://github.com/shssoichiro/sqlformat-rs)
...
- Only supports the `;` delimiter for SQL statements (custom delimiters
  are not available).
...
We welcome contributions! Feel free to submit issues or pull requests to
improve the package.

## License

This project is licensed under the MIT License. See the
[LICENSE](https://dataupsurge.github.io/SQLFormatteR/LICENSE) file for
details.

It depends on sqlformat-rs, which is also licensed under MIT.

When distributing this package, you must retain the original MIT license
notice.
